          ...
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                {({ isActive }) => (
                  <>
                    <IconComponent className={`mr-3 h-5 w-5 ${isActive ? 'text-primary' : 'text-gray-400'}`} />
                    {item.name}
                    {item.count && (
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className={`text-sm ${
                    project.active ? 'text-gray-900 font-medium' : 'text-gray-600'
                  }`}>
                    {project.name}
                  </span>
                </div>
        ...
        <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-4 border border-yellow-200">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-xs text-gray-600 leading-relaxed mb-4">
              We don't have any record for you. So feel free you can share your thoughts with your team.
            </p>
