...
import { Search, Calendar, MessageCircle, Bell, ChevronDown, Menu, X } from 'lucide-react';
          ...
          <div className="relative">
            ...
            >
              <div className="flex flex-col items-end">
                <span className="text-sm font-medium text-gray-800 hidden sm:block">Anima Agrawal</span>
                <span className="text-xs text-gray-500 hidden sm:block">U.P, India</span>
              </div>
              ...
              <div className="absolute right-0 mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg py-2 z-50">
                <div className="px-4 py-3 border-b border-gray-100">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-800">Anima Agrawal</p>
                      <p className="text-sm text-gray-500">U.P, India</p>
                      <p className="text-xs text-gray-400">anima@example.com</p>
                    </div>
                  </div>
                </div>
                <div className="py-2">
