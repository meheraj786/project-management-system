  ...
  return (
    ...
    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-8">
      ...
      <div className="flex items-start justify-between mb-6">
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            <span className="text-primary text-sm font-medium">Manage Members</span>
            <div className="flex items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className={`px-2 py-1 rounded-full text-xs font-medium border ${
            projectData?.status === 'Done' ? 'bg-green-100 text-green-800 border-green-200' :
            projectData?.status === 'In Progress' ? 'bg-purple-100 text-purple-800 border-purple-200' :
            projectData?.status === 'On Hold' ? 'bg-orange-100 text-orange-800 border-orange-200' :
            projectData?.status === 'Todo' ? 'bg-blue-100 text-blue-800 border-blue-200' :
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className={`px-2 py-1 rounded-full text-xs font-medium border ${
            projectData?.priority === 'High' ? 'bg-red-100 text-red-800 border-red-200' :
            projectData?.priority === 'Medium' ? 'bg-yellow-100 text-yellow-800 border-yellow-200' :
            projectData?.priority === 'Low' ? 'bg-green-100 text-green-800 border-green-200' :
            'bg-gray-100 text-gray-800 border-gray-200'
          }`}>
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm font-medium text-gray-800">
            {projectData?.startDate ? new Date(projectData.startDate).toLocaleDateString('en-US', {
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-medium text-gray-800">
              {projectData?.endDate ? new Date(projectData.endDate).toLocaleDateString('en-US', {
                month: 'short', day: 'numeric', year: 'numeric'
              }) : 'Not set'}
            </span>
            {projectData?.endDate && (
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm font-medium text-gray-800">
            {projectData?.budget ? `$${Number(projectData.budget).toLocaleString()}` : 'Not set'}
          </span>
        </div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          <button className="flex items-center space-x-2 px-4 py-2 border border-primary group hover:bg-primary hover:text-white rounded-lg bg-white  transition-colors">
            ...
            <span className="text-sm group-hover:text-white text-gray-700">Change Status</span>
          </button>

          <button className="flex items-center space-x-2 px-4 py-2 border border-primary group hover:bg-primary hover:text-white rounded-lg bg-white transition-colors">
            <MessageCircleDashed className="h-4 w-4 group-hover:text-gray-200 text-gray-500" />
            <span className="text-sm group-hover:text-white text-gray-700">Message</span>
          </button>
        </div>
