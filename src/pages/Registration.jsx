...
import { Eye, EyeOff, User, Mail, Lock, Phone, Building, Briefcase, Camera, ArrowRight, ArrowLeft } from 'lucide-react';
    ...
    <div className='w-full h-screen'>
      <Flex>
            ...
            <div className='flex items-center justify-center mb-8'>
              <div className='flex items-center space-x-4'>
                <div className={`flex items-center justify-center w-10 h-10 rounded-full border-2 ${
                  currentStep >= 1 ? 'bg-primary border-primary text-white' : 'border-gray-300 text-gray-400'
                }`}>
                  1
                </div>
                <div className={`w-12 h-0.5 ${currentStep >= 2 ? 'bg-primary' : 'bg-gray-300'}`}></div>
                <div className={`flex items-center justify-center w-10 h-10 rounded-full border-2 ${
                  currentStep >= 2 ? 'bg-primary border-primary text-white' : 'border-gray-300 text-gray-400'
                }`}>
                  2
                </div>
              </div>
        ...
        <div className='w-1/2 h-full object-cover'>
          <img className='w-[60%] floating h-1/2 mx-auto  object-cover' src={adminImg} alt="Admin Registration" />
        </div>
      </Flex>
    </div>
  );
